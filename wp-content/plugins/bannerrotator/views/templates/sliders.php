	...
	<div class='wrap'>
		...
		<div>		
			...
			<ul>
				...
				<li><?php _e("* From the",BANNERROTATOR_TEXTDOMAIN)?> <b><?php _e("post editor",BANNERROTATOR_TEXTDOMAIN)?></b> <?php _e("insert the shortcode from the sliders table",BANNERROTATOR_TEXTDOMAIN)?></li>
			</ul>		
		</div>
